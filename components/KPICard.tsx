        ...
        >
          <div className="mb-6 flex-1">
            ...
            {kpi.imageUrl ? (
              ...
              <div className="w-full aspect-video bg-stone-800 rounded-xl mb-4 flex items-center justify-center">
                <span className="text-stone-600 text-[10px] uppercase font-bold tracking-widest">Generazione vignetta...</span>
              </div>
            )}
